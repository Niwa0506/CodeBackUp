...
void eps_drawrect(double x, double y, double w, double h) { rect(x, y, w, h); fprintf(fd, "stroke\n");
}
...
void eps_fillcircle(double x, double y, double r) { circle(x, y, r); fprintf(fd, "fill\n");
}
